...
import { Sparkles, ArrowLeft, Loader2, X, Plus, Trash2, Tag, Layers, Hash, Coins, Banknote, LayoutGrid } from 'lucide-react';
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {formData.variants.map((variant, index) => (
                <div key={index} className="flex flex-col md:flex-row gap-4 p-4 rounded-xl bg-muted/30 border animate-in slide-in-from-left-2">
                  ...
                  <div className="w-full md:w-32 space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => updateVariant(index, 'countInStock', parseInt(e.target.value))}
                    />
                  </div>
                  <Button 
                    type="button"
              ...
              <Button type="button" variant="outline" className="w-full dashed gap-2" onClick={addVariant}>
        ...
        <div className="space-y-8">
          <Card>
            <CardHeader>
              <CardTitle>Galerie Images</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
