...
import { ShoppingCart, Menu, Search, Package, Phone, LayoutGrid, Home } from 'lucide-react';
...
export function Navbar() {
  const { cart, settings } = usePixelCart();
        ...
        <div className="flex items-center gap-4">
          <Sheet>
            ...
            <SheetContent side="left" className="w-[300px]">
              <SheetHeader>
                <SheetTitle className="text-left">{settings.brandName}</SheetTitle>
              </SheetHeader>
